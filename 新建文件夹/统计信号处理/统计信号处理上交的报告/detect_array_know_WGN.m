function [pf1_est,pfarray_est,pd1_est,pdarray_est,distance_est,doa_est,Pbeam]=detect_array_know_WGN(T,snr,pf,fs)
...
%%目标参数
distance=1000;            %目标与第一个基元距离
doa=30;                   %目标方位（与阵列法向的夹角）-90:90度
